...
UPDATE `__PREFIX__settings` SET `key` = 'unactivated_posts_expiration' WHERE `key` = 'unactivated_ads_expiration';
UPDATE `__PREFIX__settings` SET `key` = 'activated_posts_expiration' WHERE `key` = 'activated_ads_expiration';
UPDATE `__PREFIX__settings` SET `key` = 'archived_posts_expiration' WHERE `key` = 'archived_ads_expiration';
